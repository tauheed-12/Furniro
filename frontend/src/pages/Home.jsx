        ...
        <div className='flex justify-center items-center flex-col'>
            ...
            <div className='w-full flex justify-center md:justify-end items-center bg-banner bg-cover bg-center h-[400px] sm:h-[400px] md:h-[500px] lg:h-[600px]'>
                <div className='flex flex-col justify-center md:justify-start items-start p-4 sm:p-8 md:p-12 lg:p-16 bg-tertiary w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] md:mr-16 gap-2'>
                    ...
                    <h1 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl text-text-secondary font-bold w-[60%]'>
                        Discover Our New Collection
                    </h1>
                    <p className='font-semibold'>
                        Transform your home with timeless designs crafted for comfort and elegance.
                        Explore furniture that blends style with functionality, made to fit perfectly in your space.
                    </p>
            ...
            <div className='flex flex-col justify-center items-center my-6 py-4 gap-8 px-4'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <p className='text-text-primary text-center'>
                        Explore our curated selection of furniture designed for every room.
                    </p>
                </div>
            ...
            <div className='py-8'>
                ...
                {error ? (
                    ...
                    <ProductsHome
                        products={products}
                        numbOfDisplayedProduct={numbOfDisplayedProduct}
